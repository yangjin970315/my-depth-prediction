...
class DepthLitModel(LightningModule):
    ...
    def forward(self, batch):
        ...
        return output_dict
    def predict_step(self,batch,batch_id,x):
        image=batch
        #print('batch:',batch,'batch_id:',batch_id,'x',x)
        output_dict=self.net(image)
        ...
        str1='cmap'+str(batch_id)+'.png'
        plt.imsave('/home/user/pred/'+str1,pred_np,cmap='rainbow')
        print(str1,' has saved')
        #plt.imsave('/home/user/pred/cc.png',depth_pred_pil,cmap='rainbow')
